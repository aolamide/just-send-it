    ...
    return (
        <div className="p-3 font-josefinSans">
            ...
            <ol className="relative ms-3  border-s-2 border-dotted border-successGreen">
                { mockStatusUpdates.map((statusUpdate, idx) => {
                    return <DeliveryStatusUpdate key={idx} details={statusUpdate.details} datetime={statusUpdate.datetime} />
                })}
            </ol>
    ...
    return (
        <div>
            <li className="mb-10 ms-6">
                ...
                <h4 className="mb-0.5 text-base font-semibold text-gray-900 dark:text-primary-500">{datetime}</h4>
                <p className="text-sm font-normal text-gray-500 dark:text-gray-400">{details}</p>
            </li>
        </div>
    )
}
